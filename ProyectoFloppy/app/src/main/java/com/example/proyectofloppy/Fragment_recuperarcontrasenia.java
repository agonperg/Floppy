...
public class Fragment_recuperarcontrasenia extends Fragment {
    ...
    public static Fragment_recuperarcontrasenia newInstance(String param1, String param2) {
        Fragment_recuperarcontrasenia fragment = new Fragment_recuperarcontrasenia();
